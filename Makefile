...
interrupt: $(X_DIR)/int15.xsm  $(X_DIR)/int11.xsm $(X_DIR)/int8.xsm $(X_DIR)/int9.xsm $(X_DIR)/int6.xsm $(X_DIR)/int7.xsm $(X_DIR)/int10.xsm $(X_DIR)/timer.xsm $(X_DIR)/console.xsm $(X_DIR)/disk.xsm $(X_DIR)/exception.xsm
